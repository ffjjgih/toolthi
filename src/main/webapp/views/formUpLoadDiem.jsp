	...
	<div id="app">
		<header class="header">
			<div class="grid wide">
				...
				<img class="header_icon_user" src="./views/assets/image/user.png"
					alt="">
					...
					<form action="/Toolpdt/Readlsistmark" enctype="multipart/form-data"
						...
						<div class="container_body">
							<div class="container_body-button">
								<input type="file" id="UploadFileInput" class="btnFile"
									onchange="return fileValidation()"></input>
							</div>
							...
							<div class="container_body-submit">
								<button formaction="/Toolpdt/Readlsistmark" class="btn_submit"
									onclick="GFG_Fun()">SUBMIT</button>
							</div>
						</div>
					</form>
